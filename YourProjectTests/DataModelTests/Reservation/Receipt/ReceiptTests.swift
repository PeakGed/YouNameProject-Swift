...
final class ReceiptTests: XCTestCase {
    ...
    func test_statusDescription() throws {
        ...
        XCTAssertEqual(Receipt.Status.voided.description, "Voided")
    ...
    func test_statusRawValues() throws {
        ...
        XCTAssertEqual(Receipt.Status.voided.rawValue, "void")
    ...
    func test_decodingWithVoidedStatus() throws {
        ...
        XCTAssertEqual(receipt.status, .voided)
    ...
    private func createSampleReceipt() -> Receipt {
        ...
        return Receipt(
            ...
            paidDate: "2022-11-22".toDate(FormConfig.DateFormat.yyyyMMdd) ?? .now,
            currency: "THB",
            remark: nil,
            internalNote: nil,
            createdAt: dateFormatter.date(from: "2022-11-23T00:32:36.664+07:00")!,
            updatedAt: dateFormatter.date(from: "2023-07-31T12:29:27.040+07:00")!,
            hotelId: 105,
            userId: 38,
            folioFormId: nil,
            payerContactId: 4,
    ...
    private func createSampleReceiptWithAllFields() -> Receipt {
        ...
        return Receipt(
            ...
            voidedAt: dateFormatter.date(from: "2022-11-25T10:30:00.000+07:00"),
            cancelledAt: nil,
            cancelReason: nil,
            paidAt: dateFormatter.date(from: "2022-11-24T15:30:00.000+07:00"),
            ...
            paidDate: "2022-11-24".toDate(FormConfig.DateFormat.yyyyMMdd) ?? .now,
            currency: "THB",
            remark: "Test remark for all fields",
            internalNote: "Internal test note",
            createdAt: dateFormatter.date(from: "2022-11-24T00:32:36.664+07:00")!,
            updatedAt: dateFormatter.date(from: "2022-11-25T12:29:27.040+07:00")!,
            hotelId: 107,
            userId: 40,
            folioFormId: 999,
            payerContactId: 10,
